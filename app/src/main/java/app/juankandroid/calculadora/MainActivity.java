package app.juankandroid.calculadora;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn_multiplicacion.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                text_respuesta.setText( multiplicacion(Double.parseDouble(edit_numero_uno.getText().toString()),Double.parseDouble(edit_numero_dos.getText().toString()))+"");
        ...
        btn_division.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                text_respuesta.setText( division(Double.parseDouble(edit_numero_uno.getText().toString()),Double.parseDouble(edit_numero_dos.getText().toString()))+"");
